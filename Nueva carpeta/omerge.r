#' @title omerge
#'
#' @description Esta funci?n es un wrapper del merge.table que hace problema cuando la base "using" solo trae una variable. Entonces esta funci?n hace todo el merge completo porque es un cacho ir contando variables mejor que sea todo automatico.
#'
...
omerge <- function(xdf = NULL, ydf = NULL, byvar = NULL, keep = FALSE, output = TRUE){
    ...
    # Si la cantidad de NA en Master es igual al Length de las cols del master entonces no cruz? nada
    # y se clasifica como using, y as? ....
