...
# |---------------------------------------------------------------------------------| #
# 
# La función de alimenta de acveditRDS() y filterRDS() que son los reactivos cargados
# en todo momento.
# 
...
create.epi <- function(acvedit = NULL, filter = NULL){
    ...
    # no secundarios al estado de sueño como en actividorm
    ...
    # --------------------------------------------------------------------------------- #
    # Lo mejor será determinar bien antes que todo cuando es día y noche asi luego
    # solo ser haría un group_by, por noche y por estado de sueño. Por capas de variables.
    ...
    # Determinar el 1° episodio de más de x minutos
